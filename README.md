...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/txt-to-image
```

A live public deployment of this template is available at [https://txt-to-image.templates.workers.dev](https://txt-to-image.templates.workers.dev)
